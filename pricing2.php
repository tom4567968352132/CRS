...
<body id="body">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item btn"><a class="nav-link" href="pricing22.php">Sign-out</a>
    ...
    <div class="hero">
        <div class="swiper-slide p-3 fs-3">
            <img src="CRS/images/13.jpg" class="img-fluid" alt="Image 1">
            <div class="overlay">
                <h2 style="color: red;">Non-local charges</h2>
                <p>Explore the City Conveniently with Our Budget-Friendly Taxi Solutions</p>
                <button class="btn btn-outline-light p-3 fs-3" style="border-color: red; color: red;"
                    onclick="location.href='#table'">Explore Pricing</button>
            </div>
        </div>
    </div>
