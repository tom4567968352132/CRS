...
<body id="body">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item btn"><a class="nav-link" href="CRS/about.php">Sign-out</a></li>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="1.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/1.jpg"
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="2.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/2.jpg" alt="Papeete cityscape">
                </a>
                <p class="text-center">Mercedes-Benz</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="3.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/3.jpg" alt="Tevaitoa beach">
                </a>
                <p class="text-center">G-Wagen</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="4.html">
                    <img class="img-fluid border rounded img-equal-height" src="images/4.jpg" alt="Maharepa resort">
                </a>
                <p class="text-center">Land Rover</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="5.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/5.jpg" alt="Pihaena beach view">
                </a>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="13.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/13.jpg"
                        alt="Hero image - explore">
                </a>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="14.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/14.jpg" alt="Papeete cityscape">
                </a>
                <p class="text-center">Lamborgini</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="15.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/15.jpg" alt="Tevaitoa beach">
                </a>
                <p class="text-center">Mazda</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="16.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/16.jpg" alt="Maharepa resort">
                </a>
                <p class="text-center">Smart</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="17.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/17.jpg" alt="Pihaena beach view">
                </a>
                <p class="text-center">Mahindra Scorpio</p>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <a href="18.php">
                    <img class="img-fluid border rounded img-equal-height" src="images/18.jpg" alt="Punaauia seaside">
                </a>
