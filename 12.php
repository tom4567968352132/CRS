        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="php.html">Home</a></li>
                    <li class="nav-item"><a class="nav-link" href="aphp.html">About</a></li>
    ...
    <main>
        <div style="padding: 0 40px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="CRS/images/12.jpg" alt="Car 1" class="img-fluid"
                            style="border: 4px solid red; border-radius: 20px;">
                    </div>
                    <div class="col-md-6 my-auto">
                        <div class="details">
                            <h3 class="text-center">2016 Volkswagen Beetle</h3>
