...
<body id="body">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item btn"><a class="nav-link" href="pricing_.php">Sign-out</a></li>
    ...
    <div class="hero">
        <div class="swiper-slide p-3 fs-3">
            <img src="CRS/images/18.jpg" class="img-fluid" alt="Image 1">
            <div class="overlay w-50">
                <h2>Regional charges</h2>
                <p>Travel Around The City, Hassle-free With Our Affordable Cab Services</p>
                <button class="btn btn-outline-light p-3 fs-3" onclick="location.href='#table'">Explore Pricing</button>
            </div>
        </div>
    </div>
    <br>
            ...
            <table class="table table-bordered table-hover  ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>4 People</td>
                        <td>Rs.1500</td>
                        <td><button onclick="location.href='index2.php'">Rent Now</button></td>
                    </tr>
                    <tr>
    ...
    <section class="container pt-5 pb-2">
        <div class="ms-5 ps-5">
            <h4 style="color: red;">Additional Expenses</h4>
            <ul>
                <li>
                    <p>Toll and Parking Expenses</p>
                </li>
            </ul>
            <h4 class="pt-4 pb-2" style="color: red;">Terms & Conditions</h4>
            <ul>
                <li>
                    <p>Toll and Parking costs will be added post-trip.</p>
                </li>
                <li>
                    <p>The calculation starts from office to office based on time and kilometers.</p>
                </li>
                <li>
                    <p>Minimum charges apply for 8 hours or 80 kilometers.</p>
                </li>
                <li>
                    <p>A cancellation charge applies if the booking is canceled.</p>
                </li>
            </ul>
        </div>
    </section>
