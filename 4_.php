    ...
    <main>
        <div style="padding: 0 40px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="images/4.jpg" alt="Car 1" class="img-fluid"
                            style="border: 4px solid red; border-radius: 20px;">
                    </div>
                    <div class="col-md-6 my-auto">
                        <div class="details">
                            <h3 class="text-center">Land Rover</h3>
                            <hr class="text-danger w-50 m-auto">
                            <p>What is the description of a car?
                                An automobile is a usually four-wheeled vehicle designed primarily for passenger
